...
export default class REST {
  ...
  ***** */
  ...
  /* *****
  AUTH: Require usernames for certain routes (POST/PATCH/DELETE)
  ***** */
  requireusername (req, res, next, loginUrl = '/login') {
    if (env === 'production') {
  ...
  logUserAction (req, res, next, name, protocol) {
    Log.userAction(
      _.get(req, 'session.passport.user.username', 'Anonymous'),
      protocol,
